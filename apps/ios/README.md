...
La web v1.6 incluye panel de compensación (`/compensation`) y compensación por
campeonato (`/competitions/:id/compensation`, API `/api/v1/compensation/hub` y
`/api/v1/competitions/:id/compensation/*`). El cliente iOS aún no expone esta
